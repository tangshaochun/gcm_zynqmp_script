...
def firefly_reg_wr(i2c_bus_addr,dev_selected,reg_addr,reg_value):
  i2c = I2C("/dev/i2c-0")
  i2c.transfer(TCA9548_U165_ADDR, [I2C.Message([i2c_bus_addr])])   # select i2c bus
  i2c.transfer(dev_addr, [I2C.Message([reg_addr,reg])]) # write the value to the 3 configuration registers
  i2c.close()
...
tca6424_reg_wr(Z_IIC_BUS6,TCA6424_U16_ADDR,0x04,0xFF)
tca6424_reg_wr(Z_IIC_BUS6,TCA6424_U16_ADDR,0x05,0xFF)
tca6424_reg_wr(Z_IIC_BUS6,TCA6424_U16_ADDR,0x06,0xFF)
tca6424_reg_rd(Z_IIC_BUS6,TCA6424_U16_ADDR,0x04)
tca6424_reg_rd(Z_IIC_BUS6,TCA6424_U16_ADDR,0x05)
tca6424_reg_rd(Z_IIC_BUS6,TCA6424_U16_ADDR,0x06)

tca6424_reg_wr(Z_IIC_BUS6,TCA6424_U17_ADDR,0x04,0xFF)
tca6424_reg_wr(Z_IIC_BUS6,TCA6424_U17_ADDR,0x05,0xFF)
tca6424_reg_wr(Z_IIC_BUS6,TCA6424_U17_ADDR,0x06,0xFF)
tca6424_reg_rd(Z_IIC_BUS6,TCA6424_U17_ADDR,0x04)
tca6424_reg_rd(Z_IIC_BUS6,TCA6424_U17_ADDR,0x05)
tca6424_reg_rd(Z_IIC_BUS6,TCA6424_U17_ADDR,0x06)

tca6424_reg_wr(Z_IIC_BUS7,TCA6424_U13_ADDR,0x04,0xFF)
tca6424_reg_wr(Z_IIC_BUS7,TCA6424_U13_ADDR,0x05,0xFF)
tca6424_reg_wr(Z_IIC_BUS7,TCA6424_U13_ADDR,0x06,0xFF)
tca6424_reg_rd(Z_IIC_BUS7,TCA6424_U13_ADDR,0x04)
tca6424_reg_rd(Z_IIC_BUS7,TCA6424_U13_ADDR,0x05)
tca6424_reg_rd(Z_IIC_BUS7,TCA6424_U13_ADDR,0x06)

tca6424_reg_wr(Z_IIC_BUS7,TCA6424_U14_ADDR,0x04,0xFF)
tca6424_reg_wr(Z_IIC_BUS7,TCA6424_U14_ADDR,0x05,0xFF)
tca6424_reg_wr(Z_IIC_BUS7,TCA6424_U14_ADDR,0x06,0xFF)
tca6424_reg_rd(Z_IIC_BUS7,TCA6424_U14_ADDR,0x04)
tca6424_reg_rd(Z_IIC_BUS7,TCA6424_U14_ADDR,0x05)
tca6424_reg_rd(Z_IIC_BUS7,TCA6424_U14_ADDR,0x06)

tca6424_reg_wr(Z_IIC_BUS8,TCA6424_U15_ADDR,0x04,0xFF)
tca6424_reg_wr(Z_IIC_BUS8,TCA6424_U15_ADDR,0x05,0xFF)
tca6424_reg_wr(Z_IIC_BUS8,TCA6424_U15_ADDR,0x06,0xFF)
tca6424_reg_rd(Z_IIC_BUS8,TCA6424_U15_ADDR,0x04)
tca6424_reg_rd(Z_IIC_BUS8,TCA6424_U15_ADDR,0x05)
tca6424_reg_rd(Z_IIC_BUS8,TCA6424_U15_ADDR,0x06)
